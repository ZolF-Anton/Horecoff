    ...
    var W = {
        Html: function (e, t) {
                        ...
                        (this.slides = Array.prototype.slice
                            ...
                            .filter(function (t) {
                                return !t.classList.contains(
                                    e.settings.classes.slide.clone
                                );
                            }));
                },
            };
            return (
                d(n, 'root', {
                    ...
                    set: function (t) {
                        o(t) && (t = document.querySelector(t)),
                            k(t) && (n._r = t);
                    },
                }),
                d(n, 'track', {
                ...
                n.on('move', function (t) {
                    ...
                    r.Transition.after(function () {
                        n.emit('translate.jump'),
                            s.set(r.Sizes.slideWidth * i.index);
                    });
        ...
        Build: function (i, r, t) {
            var e = {
                ...
                typeClass: function () {
                    r.Html.root.classList.add(
                        i.settings.classes.type[i.settings.type]
                    );
                },
            ...
            var r = new H(),
                ...
                t = {
                    ...
                    unbindSwipeStart: function () {
                        r.off(L[0], h.Html.wrapper, s),
                            r.off(L[1], h.Html.wrapper, s);
                    },
